...
const siteConfig = {
  ...
  projectName: 'initiable-docs',
  organizationName: 'initiable',
  ...
  */
  ...
  copyright: `Copyright © ${new Date().getFullYear()} Initiable Intelligence Private Limited`,
